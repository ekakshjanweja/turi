        ...
        <div className="prose prose-gray max-w-none text-foreground">
          <div className="mb-8 p-6 bg-muted/30 rounded-lg">
            <p className="text-base leading-relaxed m-0">
              This privacy policy applies to the Turi Mail app for mobile devices that was created by Ekaksh Janweja as a Freemium service. This service is intended for use "AS IS".
            </p>
          </div>
          ...
          <div className="space-y-12">
            ...
            <section>
              ...
              <p className="mb-4 font-medium bg-destructive/10 p-4 rounded text-destructive-foreground">
                <strong>Important:</strong> The Application does not address anyone under the age of 13. The Service Provider does not knowingly collect personally identifiable information from children under 13 years of age. In the case the Service Provider discover that a child under 13 has provided personal information, the Service Provider will immediately delete this from their servers.
              </p>
