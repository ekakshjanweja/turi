        ...
        <div className="mb-8">
          ...
          <div className="bg-card border rounded-lg p-6">
            <p className="text-foreground leading-relaxed">
              This privacy policy applies to the <strong>Turi Mail app</strong>{" "}
              for mobile devices that was created by
              <strong> Ekaksh Janweja</strong> as a Freemium service. This
              service is intended for use &ldquo;AS IS&rdquo;.
            </p>
          </div>
        </div>
          ...
          <section className="bg-card border rounded-lg p-6">
            ...
            <div className="space-y-4 text-foreground">
              ...
              <p>
                ...
                to
                <strong> ekakshjanweja@gmail.com, 32, mail</strong>. The
            ...
            <div className="space-y-4 text-foreground">
              ...
              <div className="bg-destructive/10 border border-destructive/20 rounded-lg p-4">
                <p className="text-sm">
                  ...
                  children under 13 years of age. In the case the Service
                  Provider discover that a child under 13 has provided personal
