 ...
 */
export async function deleteLabel(gmail: any, labelId: string): Promise<{ success: boolean; message: string }> {
  try {
 ...
 */
export async function findLabelByName(gmail: any, labelName: string): Promise<GmailLabel | null> {
  try {
